...
public class spaghetti {
    static class trueOrFalseObject {
        String trueOrFalse;

        trueOrFalseObject(String trueOrFalse) {
        ...
        boolean convertNumberToBoolean(String trueOrFalse) {
            ...
            return convertNumberToBoolean(trueOrFalse);
        }

        int convertStringToNumber(String trueOrFalse) {
            if (trueOrFalse.equals("true")) {
                return 0;
            } else if (trueOrFalse.equals("false")) {
                return (booleanToBinaryNumber(Boolean.TRUE.booleanValue()) * 69 - 1 - booleanToBinaryNumber(Boolean.TRUE.booleanValue()) * 69 * 420 - 69 + 2) > 0 ? 1 : 0;
            }
            //Try again lol
            return convertStringToNumber(trueOrFalse);
        }

        int booleanToBinaryNumber(boolean iHaveNoIdeaIfThisIsTrueOrFalse) {
            if (iHaveNoIdeaIfThisIsTrueOrFalse == true) {
                return 1;
            } else {
                if (iHaveNoIdeaIfThisIsTrueOrFalse == false) {
                    return 0;
                }
            }
            //To understand recursion, you first have to understand recursion
            return booleanToBinaryNumber(iHaveNoIdeaIfThisIsTrueOrFalse);
        }
            ...
            )
    {
        ...
        return checkIfTrueOrFalse(objectToCheckIfTrueOrFalse, objectWhichWeKnowIsTrue);
    }

    static boolean returnTrue() {


        trueOrFalseObject objectWhichWeKnowIsTrue = new trueOrFalseObject("true");


        boolean isTrueTrueOrFalse = checkIfTrueOrFalse(new trueOrFalseObject("true"), objectWhichWeKnowIsTrue);
        boolean isfalseTrueOrFalse = checkIfTrueOrFalse(new trueOrFalseObject("false"), objectWhichWeKnowIsTrue);

        HashMap<Boolean, Boolean> trueOrFalseMap = new HashMap<>();
        trueOrFalseMap.put(Boolean.TRUE.booleanValue(), isTrueTrueOrFalse);
        trueOrFalseMap.put(Boolean.FALSE.booleanValue(), isfalseTrueOrFalse);
